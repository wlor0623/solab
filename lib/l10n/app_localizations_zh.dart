...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String get mcpServerAuthDesc =>
      '开启后需携带令牌连接（Authorization: Bearer 或 ?token=）；关闭则局域网内可直接连接。';
  ...
  @override
  String get aboutPageAppDescription => '面向授权 APK 的分析、修改与构建工具';
...
class AppLocalizationsZhHant extends AppLocalizationsZh {
  ...
  @override
  String get mcpServerAuthDesc =>
      '開啟後需攜帶權杖連線（Authorization: Bearer 或 ?token=）；關閉則區域網路內可直接連線。';
  ...
  @override
  String get aboutPageAppDescription => '面向授權 APK 的分析、修改與建置工具';
