...
class _ProvidersPageState extends State<ProvidersPage> {
  ...
  List<_Provider> _providers({required AppLocalizations l10n}) => [
    _p('OpenAI', 'OpenAI', enabled: false, models: 0),
    _p(
    ...
    _p('Gemini', 'Gemini', enabled: false, models: 0),
    _p('OpenRouter', 'OpenRouter', enabled: false, models: 0),
    _p('OpenCode', 'OpenCode', enabled: false, models: 0),
    _p('SoLabIN', 'SoLabIN', enabled: false, models: 0),
