...
class _ChatInputBarState extends State<ChatInputBar>
  ...
  // into an anchored "+" menu.
  Future<void> _showOverflowMenu(
    BuildContext context,
    List<_OverflowMenuAction> items,
  ) {
                        ...
                        child: Row(
                          children: [
                            if (item.svgAsset != null)
                              ...
                              Icon(item.icon, size: 20, color: cs.onSurface),
        ...
        if (overflowItems.isNotEmpty) {
          ...
          children.add(
            _CompactIconButton(
              ...
              icon: Lucide.Plus,
              onTap: () {
                _showOverflowMenu(context, menuItems);
              },
            ),
          );
        }
...
// Menu entry model for the responsive overflow "+" menu on the left action bar
class _OverflowMenuAction {
  const _OverflowMenuAction({
    this.icon,
    this.svgAsset,
    required this.label,
    this.onTap,
...
// Internal data model for responsive overflow actions
class _OverflowAction {
  final double width;
  final Widget Function() builder;
  final _OverflowMenuAction menu;
