...
class AsrServicesSection extends StatefulWidget {
  const AsrServicesSection({super.key, this.desktop = false});
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _ServiceSubtitle(service: widget.service),
                ],
              ),
            ),
...
class _ServiceSubtitle extends StatelessWidget {
  const _ServiceSubtitle({required this.service});
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          runSpacing: 8,
          children: [
            for (final kind in const [AsrServiceKind.system])
              _ProviderChoice(
                kind: kind,
