...
import 'package:solab/features/home/widgets/side_drawer.dart';
...
void main() {
  ...
  // Platform override must be reset inside the test body because the binding
  // verifies foundation debug variables before package:test tearDowns.
