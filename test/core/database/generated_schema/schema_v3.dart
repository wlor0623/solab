...
class ApkProjectRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ApkProjectRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  ApkProjectRows createAlias(String alias) {
    return ApkProjectRows(attachedDatabase, alias);
  }
...
class ModifyRuleRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ModifyRuleRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> category = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL CHECK (category IS NOT \'\')',
  );
  ...
  late final GeneratedColumn<String> risk = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'low\'',
    defaultValue: const CustomExpression('\'low\''),
  );
  late final GeneratedColumn<int> hitCount = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (hit_count >= 0)',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> successCount = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (success_count >= 0)',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> failureCount = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (failure_count >= 0)',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> version = GeneratedColumn<int>(
    'version',
  ...
  @override
  ModifyRuleRows createAlias(String alias) {
    return ModifyRuleRows(attachedDatabase, alias);
  }
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final ApkProjectRows apkProjectRows = ApkProjectRows(this);
  late final ModifyRuleRows modifyRuleRows = ModifyRuleRows(this);
